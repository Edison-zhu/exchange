import { FormattedOrderSpecification, FormattedTrustline, Adjustment, RippledAmount, Memo, FormattedSettings } from '../common/types/objects';
import { ApiMemo, TransactionJSON } from './utils';
export declare type TransactionJSON = TransactionJSON;
